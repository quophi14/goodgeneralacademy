...
const Staff = () => {
  return (
    ...
    className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-800 dark:text-white'>
        <Title title='Meet The Hearts Behind the Classroom' desc='Meet the professional mentors shaping the next generation through excellence and innovation. Dedicated to nurturing every child from Creche to JHS with passion, discipline, and care.'/>
